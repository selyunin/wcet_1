...
\item[A2:]
  Number of inversions in the input array. In order to take it into
  account during static WCET analysis, we need to add linear
  constraint.

\item[A3:]
  In this task we define annotation in a separate file (aiT.ais, see
  supplement).
The difference between execution times and the WCET are summarized in
the Figure~\ref{fig:opt_compare}.
